...
def save_results_to_excel(results: list, output_filepath: str):
    try:
        ...
        col_headers = ["Nazwa produktu", "ID produktu", "Liczba obrazow", "Nazwy obrazow", "Link do produktu", "Linki do obrazow"]
        ...
        for idx, result in enumerate(results, start=2):
            if result:
                ...
                worksheet.cell(row=idx, column=5, value=result.get('product_url', ''))
